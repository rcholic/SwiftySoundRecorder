...
public struct Configuration {
    ...
    public static var originalRecordingFileName: String = "recording2." // to be appended by file type
    public static var trimmedRecordingFileName: String = "recording_trimmed2."
